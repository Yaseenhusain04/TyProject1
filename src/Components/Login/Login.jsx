...
import { Box , Breadcrumbs, Button, Divider, Input} from "@mui/material";
import { ChevronRight, Highlight, Image, Mail } from "@mui/icons-material";
        ...
        <Box bg="#fff" h={"100%"} minH={"500px"} pb="60px">
          <Box padding={"8px 15px"}>
            <Box
              ...
              alignItems="center"
            >
              <Breadcrumbs fontSize={"0.9rem"} spacing="4px" separator={<ChevronRight color="black.500" />}>
                  <Link href="/">Home</Link>
                  <Link fontWeight="bold" href="/login">Account</Link>
              </Breadcrumbs>
              <Box w="13%">
                <Image
                  w="100%"
